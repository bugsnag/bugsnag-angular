...
All projects should **upgrade to our universal JS notifier**: [@bugsnag/js](https://github.com/bugsnag/bugsnag-js) and use the new version of the Angular plugin: [@bugsnag/plugin-angular](https://github.com/bugsnag/bugsnag-js/blob/master/packages/plugin-angular). See the [upgrade guide](https://github.com/bugsnag/bugsnag-js/blob/master/UPGRADING.md) for details on how to upgrade.
